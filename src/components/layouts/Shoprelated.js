...
const Shoprelated = ({ product }) => {
    console.log('21212121211',product)
  const {
    categoryProductData,
    handleNavigation,
    handleCartRelated
...
// const settings = {
//     slidesToShow: 4, // Show 4 products on larger screens
//     slidesToScroll: 1,
//     fade: false,
//     infinite: true,
//     autoplay: true,
...
//     responsive: [
//       {
//         breakpoint: 1200, // For large tablets and smaller laptops
//         settings: {
//           slidesToShow: 3,
//         },
//       },
...
//         settings: {
//           slidesToShow: 4, // Show only 1 product on mobile
//         },
//       },
//     ],
//   };
          ...
          {categoryProductData?.map((item, i) => {
            ...
            return (
              <div key={i} className="col-12 mh-100">
                <div className="food-box shop-box mr-10">
                  <div className="thumb">
                  ...
                  <div className="desc" style={{backgroundColor:'#f2f2f2'}}>
                    ...
                    <Link to='/shop-detail' state={{ product: item }} className="link">
                      <i className="fal fa-arrow-right text-black" />
                    </Link>
                  </div>
                </div>
              </div>
...
// const Shoprelated = ({ product }) => {
//   const { categoryProductData, handleNavigation, handleCartRelated } = useShopDetail(product);
//   const sliderRef = useRef(null);
...
//         <Slider className="row related-product-slider mt-40" ref={sliderRef} {...settings}>
//           {categoryProductData?.map((item, i) => {
//             const percentageDiscount = Math.round(100 - (item?.price * 100) / item?.mrp);
//             return (
//               <div key={i} className="col-12 mh-100">
//                 <div className="food-box shop-box">
//                   <div className="thumb">
//                     {/* Large Screens */}
//                     <div className="d-none d-lg-block" style={{ height: "400px", width: "100%" }}>
//                       <img
...
//                     {/* Medium Screens */}
//                     <div className="d-none d-md-block d-lg-none" style={{ height: "300px", width: "100%" }}>
//                       <img
//                         src={item?.image[0]?.path}
//                         alt="images"
//                         style={{ height: "100%", width: "100%", objectFit: "cover" }}
...
//                     {/* Small Screens */}
//                     <div className="d-block d-md-none" style={{ height: "150px", width: "100%" }}>
//                       <img
//                         src={item?.image[0]?.path}
//                         alt="images"
//                         style={{ height: "100%", width: "100%", objectFit: "cover" }}
...
//                     {item?.discount && (
//                       <div className="badges">
//                         {item?.discount > 0 ? <span className="price">Sale</span> : ""}
//                         {item?.discount > 0 ? <span className="price discounted">-{item?.discount}%</span> : ""}
//                       </div>
//                     )}
...
//                   <div className="desc" style={{ backgroundColor: "#f2f2f2" }}>
//                     <h4>
//                       <Link to="/shop-detail" state={{ product: item }} style={{ textDecoration: "none", color: "black" }}>
//                         {item?.name}
//                       </Link>
//                     </h4>
//                     <span className="price" style={{ color: "black" }}>
//                       ₹{item?.price}
//                       <span style={{ color: "grey" }}> ₹{item?.mrp} </span>
//                     </span>
//                     <span className="price" style={{ color: "black" }}>
//                       {percentageDiscount}% off
//                     </span>
