                ...
                <div className="row">
                        ...
                        <div className="checkout-form">
                            ...
                            {!openAddressForm && (
                                <>
                                        ...
                                        <div className="widget socail-widget mb-40">
                                            <div className="filter-color">
                                                <label className="checkbox">
                                                    ...
                                                    <span className="custom-box" style={{ color: 'black' }} />
                                    ...
                                    <div className="main-btn btn-filled w-100" style={{ backgroundColor: 'black' }} onClick={() => handleOpenAddressForm()}>Add New Address</div>
                                </>
                            )}
                            {openAddressForm && (
                                ...
                                <form onSubmit={handleSubmitAddress}>
                                    <div className="row">
                                        ...
                                        <div className="col-xl-6 input-group input-group-two mb-20">
                                            <button type="submit" className="main-btn btn-filled w-100" style={{backgroundColor:'black'}}>
                                                Save
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div className="col-xl-5 space-top">
                                ...
                                <tbody>
                                    {cartData?.data?.map((item, i) => (
                                        <tr key={i}>
                                            ...
                                            <td data-title="Quantity" style={{color:'black'}}>x{item.qty}</td>
                                            <td data-title="Total">
                                                <strong style={{color:'black'}}>₹{item.total}</strong>
                                            </td>
                                        </tr>
                                    ))}
                                    <tr className="total">
                                        <td>
                                            <h6 className="mb-0" style={{color:'black'}}>Total</h6>
                                        </td>
                                        <td />
                                        <td>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', border: '1px solid #000000', justifyContent: 'space-between', padding: '10px' }}>
                                <div style={{ display: 'flex', alignItems: 'center', width: '100%',color:'black' }}>₹{total} | Pay Online</div>
                                <input style={{ width: '30px', height: '30px' }} type="radio" placeholder="Card Number" name="onine" checked />
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center', border: '1px solid #000000', justifyContent: 'space-between', padding: '10px', pointerEvents: isWalletTabDiable ? 'none' : 'auto', opacity: isWalletTabDiable ? 0.5 : 1 }}>
                                <div style={{ display: 'flex', alignItems: 'center', width: '100%', color:'black' }}>₹{walletBalance} | Your Wallet</div>
                        ...
                        <div className="offset-lg-12 col-lg-12 col-md-12 mt-20 mb-20">
                            <div className="cw-product-promo">
                                <table className="table cw-table-borderless">
                                    <tbody>
                                        <tr>
                                            <td> <b style={{color:'black'}}>Total Price :</b> </td>
                                            <td className="text-right" style={{color:'black'}}>₹ {total}</td>
                                        </tr>
                                        <tr>
                                            <td> <b style={{color:'black'}}>Delivery Charge :</b> </td>
                                            <td className="text-right" style={{color:'black'}}>₹ {deliveryCharge}</td>
                                        </tr>
                                        <tr>
                                            <td> <b style={{color:'black'}}>Total Amount :</b> </td>
                                            <td className="text-right" style={{color:'black'}}>₹ {finalPrice}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
